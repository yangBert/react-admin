...
const mapState = state => ({
  billingList: state.rechargeRuleList.billingList,
  billingListPagination: state.rechargeRuleList.billingListPagination,
  spinning: state.rechargeRuleList.spinning,
  billingSelectedKeys: state.rechargeRuleList.billingSelectedKeys
});
