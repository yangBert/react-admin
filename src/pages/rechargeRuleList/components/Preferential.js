...
const mapState = state => ({
  preferentialList: state.rechargeRuleList.preferentialList,
  preferentialListPagination: state.rechargeRuleList.preferentialListPagination,
  spinning: state.rechargeRuleList.spinning,
  preferentialSelectedKeys: state.rechargeRuleList.preferentialSelectedKeys,
})
