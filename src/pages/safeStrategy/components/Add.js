...
function Add(props) {
  ...
  return (
    <div className={styles.tableForm}>
      ...
      >
        <Form>
          <div className={`${styles.formLine} clearfix`}><label className="pullLeft">安全策略名称：</label>
          ...
          <div className={`${styles.formLine} clearfix`}><label className="pullLeft">安全策略编码：</label>
            <div className={`${styles.inline} pullLeft`}>
              <Input
