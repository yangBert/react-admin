      ...
      <div className={styles.pageContet}>
        <div className="pageContentColor">
          <Card title="管理员日志详情" bordered={false}>
            <Descriptions>
              <Descriptions.Item label="操作人：">{adminId}</Descriptions.Item>
              <Descriptions.Item label="操作描述：">{config.method[method] ? config.method[method] : "--"}</Descriptions.Item>
              <Descriptions.Item label="操作编码：">{operateType}</Descriptions.Item>
              <Descriptions.Item label="操作时间：">{$$.getHours(logTime)}</Descriptions.Item>
            </Descriptions>
